...
$base_url="http://dunex-intranet.com"; //url base of site if you want only relative url leave empty
$upload_dir = '/javascript/jscript/tinymce/source/'; // path from base_url to upload base dir
